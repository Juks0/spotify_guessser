        ...
        <div>
            ...
            {userData ? (
                <div>
                    ...
                    <p>Country: {getFlagEmoji(userData.country)} {userData.country}</p>
                </div>
            ) : (
                    ...
                    <div>
                        ...
                        {playbackState.progress_ms !== undefined && (
                            <div>
                                ...
                                ></progress>
                                <p>{formatTime(playbackState.progress_ms)} / {formatTime(playbackState.item.duration_ms)}</p>
                            </div>
                        )}
                    </div>
                ) : (
                            ...
                            <div key={friend.id}>
                                <div>
                                    ...
                                    <div>
                                        <p>{friend.username}</p>
                                        {friend.last_login && (
                                            <p>Last seen: {new Date(friend.last_login).toLocaleDateString()}</p>
                                        )}
                                    </div>
                                </div>
